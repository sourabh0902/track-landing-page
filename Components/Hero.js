    ...
    <div>
        ...
        <div className=' container'>
            ...
            <div className=' flex justify-center items-center gap-3'>
                <button className=' text-base font-semibold bg-[#DBF301] px-6 py-3 rounded-xl'>Get Started</button>
                <button className=' border-[#DBF301] border text-base font-semibold px-6 py-3 rounded-xl'>Book Demo</button>
            </div>
        </div>
